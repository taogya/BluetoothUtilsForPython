# Generated by Django 4.2.2 on 2023-06-14 09:08
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('note', models.CharField(blank=True, default=False, help_text='device id/name/etc...', max_length=256, null=True, verbose_name='note')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('interval', models.FloatField(default=3.0, help_text='default 3.0[sec], 0.0 is not monitored', validators=[django.core.validators.MinValueValidator(0.0)], verbose_name='monitoring interval of is_enabled [sec]')),
            ],
            options={
